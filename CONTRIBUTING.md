...
This tricks poetry into installing the dummy package as editable, but the `kserve` and server-specific packages statically (copying the files into `.../dist-packages`).  
